...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\dev\php\akilimo-api\public\storage' => 'string',
            ...
            'models.*.casts.droid_request' => 'string',
            'models.*.casts.plumber_request' => 'string',
            'models.*.casts.plumber_response' => 'string',
            'models.*.except' => 'array',
            'models.*.only' => 'array',
            ...
            'services.plumbr.endpoint' => 'string',
            'services.plumbr.timeout' => 'integer',
            ...
            'useful-additions.refresh_db_fast.seed' => 'boolean',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\dev\\php\\akilimo-api\\public\\storage','logging.default','logging.deprecations.channel',
...
'models.*.casts.*_json','models.*.casts.droid_request','models.*.casts.plumber_request','models.*.casts.plumber_response','models.*.except',
...
'models.*.fillable_in_base_files','models.*.enable_return_types','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.plumbr.endpoint','services.plumbr.timeout','session.driver',
...
'migrations-generator.filename_pattern.foreign_key','useful-additions.refresh_db_fast.seed','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver',
'structure-discoverer.cache.store','db-auditor.skip_tables','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'welcome','DBAuditor::auditor.layouts.default','DBAuditor::auditor.pages.audit','DBAuditor::error_message','DBAuditor::mysql.constraint',
'DBAuditor::mysql.standard','DBAuditor::mysql.table_standard','DBAuditor::pgsql.constraint','DBAuditor::pgsql.standard','DBAuditor::pgsql.table_standard',
'DBAuditor::sqlite.constraint','DBAuditor::sqlite.standard','DBAuditor::sqlite.table_standard','DBAuditor::success_message','laravel-exceptions-renderer::components.card',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','Lang::messages.constraint.question.table_selection','Lang::messages.constraint.question.add_constraint',
'Lang::messages.constraint.question.constraint_selection','Lang::messages.constraint.question.field_selection','Lang::messages.constraint.question.foreign_table','Lang::messages.constraint.question.foreign_field','Lang::messages.constraint.success_message.constraint_added',
'Lang::messages.constraint.error_message.constraint_not_apply','Lang::messages.constraint.error_message.foreign_not_apply','Lang::messages.constraint.error_message.table_not_found','Lang::messages.constraint.error_message.field_not_found','Lang::messages.constraint.error_message.foreign_selected_table_match',
'Lang::messages.constraint.error_message.unique_constraint_not_apply','Lang::messages.standard.error_message.length','Lang::messages.standard.error_message.plural','Lang::messages.standard.error_message.space','Lang::messages.standard.error_message.alphabets',
'Lang::messages.standard.error_message.convention','Lang::messages.standard.error_message.datatype_change','Lang::messages.standard.question.table_selection',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','PLUMBR_ENDPOINT',);
