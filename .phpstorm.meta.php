...
'models.*.model_names','models.*.relation_name_strategy','models.*.with_property_constants','models.*.with_column_list','models.*.pluralize',
'models.*.override_pluralize_for','models.*.hidden_in_base_files','models.*.fillable_in_base_files','models.*.enable_return_types','queue.default',
...
'migrations-generator.filename_pattern.foreign_key','db-auditor.skip_tables','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'web','api',);
        registerArgumentsSet('routes', 'currencies.all','storage.local',);
...
'MEMCACHED_HOST','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','REDIS_QUEUE',
