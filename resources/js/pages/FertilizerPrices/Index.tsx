...
interface Props { items: Paginated<FertilizerPrice> }

export default function FertilizerPricesIndex({ items }: Props) {
    ...
    function handlePageChange(page: number) {
        router.get('/admin/fertilizer-prices', { page }, { preserveState: true })
    }
