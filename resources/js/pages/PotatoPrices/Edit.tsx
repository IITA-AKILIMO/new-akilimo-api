...
interface Props { item: PotatoPrice }

export default function PotatoPricesEdit({ item }: Props) {
    ...
    function handleSubmit(e: FormEvent) { e.preventDefault(); put(`/admin/potato-prices/${item.id}`) }
    return (
        <AdminLayout title="Edit Potato Price">
