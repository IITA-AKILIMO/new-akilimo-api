...
interface Props { items: Paginated<OperationCost> }

export default function OperationCostsIndex({ items }: Props) {
    ...
    function handlePageChange(page: number) { router.get('/admin/operation-costs', { page }, { preserveState: true }) }
