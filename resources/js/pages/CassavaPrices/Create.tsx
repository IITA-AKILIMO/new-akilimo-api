...
export default function CassavaPricesCreate() {
    const { data, setData, post, processing, errors } = useForm({
        country: '', min_local_price: '', max_local_price: '',
        min_usd: '', max_usd: '', min_price: '', max_price: '', price_active: true, sort_order: '',
    })
    function handleSubmit(e: FormEvent) { e.preventDefault(); post('/admin/cassava-prices') }
    return (
        <AdminLayout title="New Cassava Price">
            <div className="mx-auto" style={{ maxWidth: 700 }}>
                <ResourceForm title="Create Cassava Price" onSubmit={handleSubmit} processing={processing} onCancel={() => window.history.back()}>
