...
export default function MaizePricesCreate() {
    const { data, setData, post, processing, errors } = useForm({
        country: '', produce_type: '', min_local_price: '', max_local_price: '',
        min_usd: '', max_usd: '', min_price: '', max_price: '', price_active: true, sort_order: '',
    })
    function handleSubmit(e: FormEvent) { e.preventDefault(); post('/admin/maize-prices') }
    return (
        <AdminLayout title="New Maize Price">
